...
| graphics         | 3.6.3                             | R package                                             | R Core Team (2020). stats. https://cran.r-project.org/bin/windows/base/old/3.6.3/ |
| grDevices        | 3.6.3                             | R package                                             | R Core Team (2020). stats. https://cran.r-project.org/bin/windows/base/old/3.6.3/ |
