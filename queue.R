  ...
  while(TRUE){
    ...
    if(length(inputSets < 6)){
      ...
      #lapply(inputSets, function(input){
        ...
        if(mode == "annotation") {
          #resp <- GET(url="http://localhost:8000/", path="getAnnotations", query=list(enrichmentUUID=enrichmentUUID, annoSelectStr=annoSelectStr))
          #future_promise({
          ...
          #resp <- GET(url="http://localhost:8000/", path="enrich", query=list(enrichmentUUID=enrichmentUUID, annoSelectStr=annoSelectStr, nodeCutoff=nodeCutoff))
          #future({
        ...
        if (status_code == 200){
          ...
          #print(paste0("Error performing enrichment: ", resp$status_code, " : ", content(resp, as="text")))
